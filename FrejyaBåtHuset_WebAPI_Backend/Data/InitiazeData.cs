...
namespace FrejyaBåtHuset_WebAPI_Backend.Data
{
    public class InitiazeData
    {
        ...
        private static void SeedUsersData()
        {
            ...
            users.Add(new User() { EmailId = "indira12@gmail.com", Password = "indira", UserName = "indira", UserType = "user" });
        ...
        private static void SeedBåtHusetBokningData()
        {
            ...
            //båtHusetBokning.Add(new BåtHusetBokning() { DiscoverBoatHouse = 1, BoatTripPrice = 350, BoatTripDate = Convert.ToDateTime("2020-12-23"), BoatStartTime = " 10:00:00", BoatEndTime = " 19:00:00", OtherActivities ="Chess", ActivitiesTiming = "6pm-7pm", Restaurant = " Vegeterian FriedRice 190", PriceOfTicket = 450, Beverages = "Vodka" });
            //båtHusetBokning.Add(new BåtHusetBokning() { DiscoverBoatHouse = 1, BoatTripPrice = 350, BoatTripDate = Convert.ToDateTime("2020-12-23"), BoatStartTime = " 10:00:00", BoatEndTime = " 19:00:00", OtherActivities ="Magic Show", ActivitiesTiming = "5pm-6pm", Restaurant = "Non-Vegeterian FriedRice 200 ", PriceOfTicket = 1500, Beverages = "Tea" });
            //båtHusetBokning.Add(new BåtHusetBokning() { DiscoverBoatHouse = 1, BoatTripPrice = 350, BoatTripDate = Convert.ToDateTime("2020-12-23"), BoatStartTime = " 10:00:00", BoatEndTime = " 19:00:00", OtherActivities ="Singing Concert", ActivitiesTiming = "4pm-5pm", Restaurant = "Vegeterian MixedRice 190 ", PriceOfTicket = 1200, Beverages = "Wine" });
