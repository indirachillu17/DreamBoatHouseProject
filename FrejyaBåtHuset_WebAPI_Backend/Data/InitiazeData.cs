...
namespace FrejyaBåtHuset_WebAPI_Backend.Data
{
    public class InitiazeData
    {
        ...
        private static void SeedAndraaktiviteterData()
        {
            ...
            andraAktiviteter.Add(new Andraaktiviteter() {OtherActivities = "Spa-Center", Price = 1000, ActivitiesTiming = "13pm-14pm" });
            andraAktiviteter.Add(new Andraaktiviteter() {OtherActivities = "Fish Pedicure and Manicure", Price = 1500, ActivitiesTiming = "14pm-15pm"});
            andraAktiviteter.Add(new Andraaktiviteter() {OtherActivities = "Dance Show", Price=750, ActivitiesTiming = "15pm-16pm" });
            andraAktiviteter.Add(new Andraaktiviteter() {OtherActivities = "Singing Concert", Price=1200, ActivitiesTiming = "16pm-17pm"});
            andraAktiviteter.Add(new Andraaktiviteter() { OtherActivities = "Magic Show", Price = 600, ActivitiesTiming = "17pm-18pm" });
            andraAktiviteter.Add(new Andraaktiviteter() { OtherActivities = "Chess", Price = 450, ActivitiesTiming = "18pm-19pm" });
