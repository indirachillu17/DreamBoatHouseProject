...
namespace FreyjaBåtHuset_API_Backend.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class BoatTripBookingsController : ControllerBase
    {
        private readonly FreyjaBåtHuset_API_BackendContext _context;

        public BoatTripBookingsController(FreyjaBåtHuset_API_BackendContext context)
        {
            _context = context;
        }
